//return the sum of 1 to N.  For example Sum1toN(3) would return the sum of 1+2+3 which is 6.copy
...
describe("returnLargest", function() {
  it("should return 10 when we pass [1,3,10] as an arugment", function() {
    expect(returnLargest([1,3,10])).toEqual(10);
  });
  it("should return -2 when we pass [-2,-5,-10] as an arugment", function(){
